...
define(function (require, exports, module) {
    ...
    (function () {
        ...
        t.d = function (a, c, d) {
            ...
            e.X || (e.disabled = l, e.X = function (c) {
                if (!e.disabled) {
                    c = t.pc(c);
                    var d = e.C[c.type];
                    if (d) for (var d = d.slice(0), j = 0, n = d.length; j < n && !c.wc(); j++) d[j].call(a, c)
                }
            });
        ...
        s.options = function (a) {
            return a === b ? this.k : this.k = t.ga.Va(this.k, a)
        };
        s.e = function (a, c) {
            return t.e(a, c)
        };
        ...
        s.removeChild = function (a) {
            ...
            if (a && this.M) {
                for (var c = l, d = this.M.length - 1; 0 <= d; d--) if (this.M[d] === a) {
                    c = f;
                    this.M.splice(d, 1);
                    break
                }
        ...
        s.I = function (a) {
            a && (this.la ? a.call(this)  : (this.ab === b && (this.ab = [
            ]), this.ab.push(a)));
            return this
        };
        s.Fa = function () {
        ...
        s.va = m();
        s.S = function () {
            return this.className + ' vjs-menu-button ' + t.t.prototype.S.call(this)
        };
        s.Ya = m();
        s.Xa = m();
        s.r = function () {
        ...
        for (var K = 0; K < t.D.Sa.length; K++) t.D[t.D.Sa[K]] = K,
        t.D.prototype[t.D.Sa[K]] = K;
        var L,
        M,
        N,
        O;
        ...
        t.Player = t.a.extend({
            i: function (a, c, d) {
                ...
                t.Ba[this.T] = this;
                c.plugins && t.h.Y(c.plugins, function (a, c) {
                    this[a](c)
                }, this);
                var e,
                g,
        ...
        s.Ld = function () {
            this.error(k);
            this.paused() ? (Q(this, l), this.W('play', function () {
                Q(this, f)
            }))  : this.l('firstplay')
        };
        s.tc = l;
        function Q(a, c) {
            c !== b && a.tc !== c && ((a.tc = c) ? (a.n('vjs-has-started'), a.l('firstplay'))  : a.p('vjs-has-started'))
        }
        s.Nb = function () {
            this.p('vjs-paused');
            this.n('vjs-playing')
        ...
        function R(a, c) {
            if (a.m && a.m.la) try {
                ...
                throw a.m[c] === b ? t.log('Video.js: ' + c + ' method not defined for ' + a.eb + ' playback technology.', d)  : 'TypeError' == d.name ? (t.log('Video.js: ' + c + ' unavailable on ' + a.eb + ' playback technology element.', d), a.m.la = l)  : t.log(d),
                d;
            }
        }
        s.play = function () {
        ...
        s.selectSource = function (a) {
            for (var c = 0, d = this.k.techOrder; c < d.length; c++) {
                var e = t.aa(d[c]),
                g = window.videojs[e];
                if (g) {
        ...
        s.src = function (a) {
            ...
            t.h.isArray(a) ? T(this, a)  : 'string' === typeof a ? this.src({
                src: a
            })  : a instanceof Object && (a.type && !window.videojs[this.eb].canPlaySource(a) ? T(this, [
                a
            ])  : (this.F.src = a.src, this.mc = a.type || '', this.I(function () {
                S(this, 'src', a.src);
        ...
        function T(a, c) {
            ...
            e;
            d ? d.m === a.eb ? a.src(d.source)  : P(a, d.m, d.source)  : (e = setTimeout(t.bind(a, function () {
                this.error({
                    code: 4,
        ...
        s.Ca = function (a) {
            return a !== b ? (S(this, 'setPreload', a), this.k.preload = a, this)  : R(this, 'preload')
        };
        s.autoplay = function (a) {
            return a !== b ? (S(this, 'setAutoplay', a), this.k.autoplay = a, this)  : R(this, 'autoplay')
        };
        s.loop = function (a) {
            return a !== b ? (S(this, 'setLoop', a), this.k.loop = a, this)  : R(this, 'loop')
        };
        s.poster = function (a) {
        ...
        s.usingNativeControls = function (a) {
            return a !== b ? (a = !!a, this.Sb !== a && ((this.Sb = a) ? (this.n('vjs-using-native-controls'), this.l('usingnativecontrols'))  : (this.p('vjs-using-native-controls'), this.l('usingcustomcontrols'))), this)  : this.Sb
        };
        s.ca = k;
        s.error = function (a) {
        ...
        s.userActive = function (a) {
            return a !== b ? (a = !!a, a !== this.Rb && ((this.Rb = a) ? (this.pa = f, this.p('vjs-user-inactive'), this.n('vjs-user-active'), this.l('useractive'))  : (this.pa = l, this.m && this.m.W('mousemove', function (a) {
                a.stopPropagation();
                a.preventDefault()
        ...
        s.ta = 'Play';
        s.S = function () {
            return 'vjs-play-control ' + t.t.prototype.S.call(this)
        };
        s.r = function () {
        ...
        t.hb.prototype.fa = function () {
            var a = this.c.bb ? this.c.F.currentTime : this.c.currentTime();
        ...
        t.Ja.prototype.S = function () {
            return 'vjs-fullscreen-control ' + t.t.prototype.S.call(this)
        };
        ...
        s.Bc = 'timeupdate';
        s.e = function () {
            return t.P.prototype.e.call(this, 'div', {
        ...
        s.wa = function () {
            ...
            if (c) for (var d = c.length - 1; 0 <= d; d--) a.Q(new t.nb(this.j(), {
                rate: c[d] + 'x'
            }));
            return a
        };
        ...
        s.Pc = function () {
            U(this) && (this.xc.innerHTML = this.j().playbackRate() + 'x')
        };
        t.nb = t.H.extend({
            kc: 'button',
            i: function (a, c) {
                var d = this.label = c.rate,
                e = this.Ec = parseFloat(d, 10);
                c.label = d;
                c.selected = 1 === e;
                t.H.call(this, a, c);
        ...
        t.nb.prototype.update = function () {
            this.selected(this.j().playbackRate() == this.Ec)
        };
        t.Ka = t.t.extend({
            i: function (a, c) {
                t.t.call(this, a, c);
        ...
        t.q = t.a.extend({
            i: function (a, c, d) {
                ...
                c.Gc = l;
                t.a.call(this, a, c, d);
                this.featuresProgressEvents || (this.yc = f, this.Dc = setInterval(t.bind(this, function () {
                    var a = this.j().bufferedPercent();
                    this.hd != a && this.j().l('progress');
                    this.hd = a;
                    1 === a && clearInterval(this.Dc)
                }), 500));
                this.featuresTimeupdateEvents || (this.Kb = f, this.j().d('play', t.bind(this, this.Oc)), this.j().d('pause', t.bind(this, this.cb)), this.W('timeupdate', function () {
        ...
        s.dispose = function () {
            this.yc && (this.yc = l, clearInterval(this.Dc));
            this.Kb && fa(this);
            t.a.prototype.dispose.call(this)
        };
        s.Pb = function () {
            this.Kb && this.j().l('timeupdate')
        };
        s.Ic = m();
        ...
        t.g = t.q.extend({
            i: function (a, c, d) {
                this.featuresVolumeControl = t.g.kd();
                ...
                t.q.call(this, a, c, d);
                for (d = t.g.kb.length - 1; 0 <= d; d--) t.d(this.b, t.g.kb[d], t.bind(this, this.sd));
                ...
                a.I(function () {
                    this.O && (this.k.autoplay && this.paused()) && (delete this.O.poster, this.play())
                });
                this.Fa()
            }
        });
        ...
        s.e = function () {
            ...
            c = a.O,
            d;
            if (!c || this.movingMediaElementInDOM === l) c ? (d = c.cloneNode(l), t.g.Bb(c), c = d, a.O = k)  : (c = t.e('video'), t.Hc(c, t.h.z(a.ee || {
            }, {
                id: a.id() + '_html5_api',
                'class': 'vjs-tech'
            }))),
        ...
        t.g.Ac = function () {
            ...
            t.$c && (V || (V = t.A.constructor.prototype.canPlayType), t.A.constructor.prototype.canPlayType = function (a) {
        ...
        function Y(a, c, d) {
            for (var e = a.Ea, g = 0, h = e.length, j, n; g < h; g++) j = e[g],
            j.id() === c ? (j.show(), n = j)  : d && (j.J() == d && 0 < j.mode()) && j.disable();
        ...
        s.load = function () {
            0 === this.na && (this.na = 1, t.get(this.Jc, t.bind(this, this.Sd), t.bind(this, this.Id)))
        };
        s.Id = function (a) {
            this.error = a;
            this.na = 3;
        ...
        s.Sd = function (a) {
            ...
            for (var e = '', g = 1, h = a.length; g < h; g++) if (e = t.trim(a[g])) {
                - 1 == e.indexOf('-->') ? (c = e, e = t.trim(a[++g]))  : c = this.ba.length;
                c = {
                    id: c,
        ...
        s.va = function () {
            for (var a = [
            ], c, d = 0; d < this.c.textTracks().length; d++) c = this.c.textTracks() [d],
            c.J() === this.G && a.push(new t.$(this.c, {
                track: c
            }));
            return a
        ...
        s.wa = function () {
            for (var a = this.c.textTracks(), c = 0, d = a.length, e, g, h = this.N = [
            ]; c < d; c++) if (e = a[c], e.J() == this.G) if (0 === e.readyState()) e.load(),
            ...
            if (g) {
                e = g.ba;
                for (var j, c = 0, d = e.length; c < d; c++) j = e[c],
                j = new t.gb(this.c, {
                    track: g,
                    cue: j
                }),
        ...
        t.h.z(t.Ia.prototype.k.children, {
            subtitlesButton: {
            },
            captionsButton: {
            },
        ...
        t.ic = function () {
            ...
            if (d && 0 < d.length) for (var e = 0, g = d.length; e < g; e++) if ((c = d[e]) && c.getAttribute) c.player === b && (a = c.getAttribute('data-setup'), a !== k && (a = t.JSON.parse(a || '{}'), videojs(c, a)));
             else {
                t.ub();
                break
            } else t.Rc || t.ub()
        ...
        'complete' === document.readyState ? t.Rc = f : t.W(window, 'load', function () {
            t.Rc = f
        });
        t.ub();
        t.Ud = function (a, c) {
